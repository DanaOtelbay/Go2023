...
func NewDeveloper(position string, salary float64, address string) *Developer {
	return &Developer{position: position, salary: salary, address: address}
}
...
func (d *Developer) WriteCode() string {
	return "Code written by Developer"
}

func (d *Developer) TestCode() string {
	return "Code tested by Developer"
}
